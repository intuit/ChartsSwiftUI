...
1. Ensure that you have forked the ChartsSwiftUI repo and are creating a pull request from that branch. You will not be able to directly push the ChartsSwiftUI main repo.
...
Please visit our [Code of Conduct page]("../CODE_OF_CONDUCT.md")